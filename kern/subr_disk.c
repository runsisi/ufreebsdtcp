...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: release/9.2.0/sys/kern/subr_disk.c 212160 2010-09-02 19:40:28Z gibbs $");
 ...
 */
static inline bsd_uoff_t
bioq_bio_key(struct bio_queue_head *head, struct bio *bp)
{

	return ((bsd_uoff_t)(bp->bio_offset - head->last_offset));
}
