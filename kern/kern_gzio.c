...
/* @(#) $FreeBSD: release/9.2.0/sys/kern/kern_gzio.c 233353 2012-03-23 11:26:54Z kib $ */
...
typedef struct gz_stream {
    ...
    bsd_off_t    outoff;  /* current offset in output file */
    int	     flags;
} gz_stream;
...
local void   putU32      OF((gz_stream *file, bsd_uint32_t x));
...
#endif
        putU32 (s, s->crc);
        putU32 (s, (bsd_uint32_t) s->stream.total_in);
    }
    return destroy((gz_stream*)file);
}
