...
typedef int card_set_res_flags_t(bsd_device_t dev, bsd_device_t child, int restype,
                                 int rid, u_long value);

static __inline int CARD_SET_RES_FLAGS(bsd_device_t dev, bsd_device_t child,
...
typedef int card_get_res_flags_t(bsd_device_t dev, bsd_device_t child, int restype,
                                 int rid, u_long *value);

static __inline int CARD_GET_RES_FLAGS(bsd_device_t dev, bsd_device_t child,
                                       int restype, int rid, u_long *value)
{
	kobjop_t _m;
...
typedef int card_set_memory_offset_t(bsd_device_t dev, bsd_device_t child, int rid,
                                     bsd_uint32_t cardaddr, bsd_uint32_t *deltap);

static __inline int CARD_SET_MEMORY_OFFSET(bsd_device_t dev, bsd_device_t child,
                                           int rid, bsd_uint32_t cardaddr,
                                           bsd_uint32_t *deltap)
{
	kobjop_t _m;
...
typedef int card_get_memory_offset_t(bsd_device_t dev, bsd_device_t child, int rid,
                                     bsd_uint32_t *offset);

static __inline int CARD_GET_MEMORY_OFFSET(bsd_device_t dev, bsd_device_t child,
                                           int rid, bsd_uint32_t *offset)
{
	kobjop_t _m;
...
typedef int card_attach_card_t(bsd_device_t dev);

static __inline int CARD_ATTACH_CARD(bsd_device_t dev)
{
	kobjop_t _m;
...
typedef int card_detach_card_t(bsd_device_t dev);

static __inline int CARD_DETACH_CARD(bsd_device_t dev)
{
	kobjop_t _m;
...
typedef const struct pccard_product * card_do_product_lookup_t(bsd_device_t bus,
                                                               bsd_device_t dev,
                                                               const struct pccard_product *tab, bsd_size_t ent_size, pccard_product_match_fn matchfn);

static __inline const struct pccard_product * CARD_DO_PRODUCT_LOOKUP(bsd_device_t bus, bsd_device_t dev, const struct pccard_product *tab, bsd_size_t ent_size, pccard_product_match_fn matchfn)
{
	kobjop_t _m;
...
typedef int card_cis_scan_t(bsd_device_t bus, bsd_device_t dev, pccard_scan_t fnp,
                            void *argp);

static __inline int CARD_CIS_SCAN(bsd_device_t bus, bsd_device_t dev, pccard_scan_t fnp,
                                  void *argp)
{
	kobjop_t _m;
...
typedef int card_attr_read_t(bsd_device_t bus, bsd_device_t dev, bsd_uint32_t offset,
                             bsd_uint8_t *val);

static __inline int CARD_ATTR_READ(bsd_device_t bus, bsd_device_t dev, bsd_uint32_t offset,
                                   bsd_uint8_t *val)
{
	kobjop_t _m;
...
typedef int card_attr_write_t(bsd_device_t bus, bsd_device_t dev, bsd_uint32_t offset,
                              bsd_uint8_t val);

static __inline int CARD_ATTR_WRITE(bsd_device_t bus, bsd_device_t dev, bsd_uint32_t offset,
                                    bsd_uint8_t val)
{
	kobjop_t _m;
...
typedef int card_ccr_read_t(bsd_device_t bus, bsd_device_t dev, bsd_uint32_t offset,
                            bsd_uint8_t *val);

static __inline int CARD_CCR_READ(bsd_device_t bus, bsd_device_t dev, bsd_uint32_t offset,
                                  bsd_uint8_t *val)
{
	kobjop_t _m;
...
typedef int card_ccr_write_t(bsd_device_t bus, bsd_device_t dev, bsd_uint32_t offset,
                             bsd_uint8_t val);

static __inline int CARD_CCR_WRITE(bsd_device_t bus, bsd_device_t dev, bsd_uint32_t offset,
                                   bsd_uint8_t val)
{
	kobjop_t _m;
