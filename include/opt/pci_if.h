...
typedef bsd_uint32_t pci_read_config_t(bsd_device_t dev, bsd_device_t child, int reg,
                                    int width);

static __inline bsd_uint32_t PCI_READ_CONFIG(bsd_device_t dev, bsd_device_t child, int reg,
                                          int width)
{
	kobjop_t _m;
...
typedef void pci_write_config_t(bsd_device_t dev, bsd_device_t child, int reg,
                                bsd_uint32_t val, int width);

static __inline void PCI_WRITE_CONFIG(bsd_device_t dev, bsd_device_t child, int reg,
                                      bsd_uint32_t val, int width)
{
	kobjop_t _m;
...
typedef int pci_get_powerstate_t(bsd_device_t dev, bsd_device_t child);

static __inline int PCI_GET_POWERSTATE(bsd_device_t dev, bsd_device_t child)
{
	kobjop_t _m;
...
typedef int pci_set_powerstate_t(bsd_device_t dev, bsd_device_t child, int state);

static __inline int PCI_SET_POWERSTATE(bsd_device_t dev, bsd_device_t child, int state)
{
	kobjop_t _m;
...
typedef int pci_get_vpd_ident_t(bsd_device_t dev, bsd_device_t child,
                                const char **identptr);

static __inline int PCI_GET_VPD_IDENT(bsd_device_t dev, bsd_device_t child,
                                      const char **identptr)
{
	kobjop_t _m;
...
typedef int pci_get_vpd_readonly_t(bsd_device_t dev, bsd_device_t child, const char *kw,
                                   const char **vptr);

static __inline int PCI_GET_VPD_READONLY(bsd_device_t dev, bsd_device_t child,
...
typedef int pci_enable_busmaster_t(bsd_device_t dev, bsd_device_t child);

static __inline int PCI_ENABLE_BUSMASTER(bsd_device_t dev, bsd_device_t child)
{
	kobjop_t _m;
...
typedef int pci_disable_busmaster_t(bsd_device_t dev, bsd_device_t child);

static __inline int PCI_DISABLE_BUSMASTER(bsd_device_t dev, bsd_device_t child)
{
	kobjop_t _m;
...
typedef int pci_enable_io_t(bsd_device_t dev, bsd_device_t child, int space);

static __inline int PCI_ENABLE_IO(bsd_device_t dev, bsd_device_t child, int space)
{
	kobjop_t _m;
...
typedef int pci_disable_io_t(bsd_device_t dev, bsd_device_t child, int space);

static __inline int PCI_DISABLE_IO(bsd_device_t dev, bsd_device_t child, int space)
{
	kobjop_t _m;
...
typedef int pci_assign_interrupt_t(bsd_device_t dev, bsd_device_t child);

static __inline int PCI_ASSIGN_INTERRUPT(bsd_device_t dev, bsd_device_t child)
{
	kobjop_t _m;
...
typedef int pci_find_extcap_t(bsd_device_t dev, bsd_device_t child, int capability,
                              int *capreg);

static __inline int PCI_FIND_EXTCAP(bsd_device_t dev, bsd_device_t child,
...
typedef int pci_alloc_msi_t(bsd_device_t dev, bsd_device_t child, int *count);

static __inline int PCI_ALLOC_MSI(bsd_device_t dev, bsd_device_t child, int *count)
{
	kobjop_t _m;
...
typedef int pci_alloc_msix_t(bsd_device_t dev, bsd_device_t child, int *count);

static __inline int PCI_ALLOC_MSIX(bsd_device_t dev, bsd_device_t child, int *count)
{
	kobjop_t _m;
...
typedef int pci_remap_msix_t(bsd_device_t dev, bsd_device_t child, int count,
                             const u_int *vectors);

static __inline int PCI_REMAP_MSIX(bsd_device_t dev, bsd_device_t child, int count,
                                   const u_int *vectors)
{
	kobjop_t _m;
...
typedef int pci_release_msi_t(bsd_device_t dev, bsd_device_t child);

static __inline int PCI_RELEASE_MSI(bsd_device_t dev, bsd_device_t child)
{
	kobjop_t _m;
...
typedef int pci_msi_count_t(bsd_device_t dev, bsd_device_t child);

static __inline int PCI_MSI_COUNT(bsd_device_t dev, bsd_device_t child)
{
	kobjop_t _m;
...
typedef int pci_msix_count_t(bsd_device_t dev, bsd_device_t child);

static __inline int PCI_MSIX_COUNT(bsd_device_t dev, bsd_device_t child)
{
	kobjop_t _m;
