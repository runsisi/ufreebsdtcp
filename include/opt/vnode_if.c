...
SDT_PROBE_DEFINE2(vfs, vop, vop_islocked, entry, entry, "struct vnode *", "struct vop_islocked_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_islocked, return, return, "struct vnode *", "struct vop_islocked_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_lookup, entry, entry, "struct vnode *", "struct vop_lookup_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_lookup, return, return, "struct vnode *", "struct vop_lookup_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_cachedlookup, entry, entry, "struct vnode *", "struct vop_cachedlookup_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_cachedlookup, return, return, "struct vnode *", "struct vop_cachedlookup_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_create, entry, entry, "struct vnode *", "struct vop_create_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_create, return, return, "struct vnode *", "struct vop_create_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_whiteout, entry, entry, "struct vnode *", "struct vop_whiteout_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_whiteout, return, return, "struct vnode *", "struct vop_whiteout_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_mknod, entry, entry, "struct vnode *", "struct vop_mknod_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_mknod, return, return, "struct vnode *", "struct vop_mknod_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_open, entry, entry, "struct vnode *", "struct vop_open_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_open, return, return, "struct vnode *", "struct vop_open_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_close, entry, entry, "struct vnode *", "struct vop_close_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_close, return, return, "struct vnode *", "struct vop_close_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_access, entry, entry, "struct vnode *", "struct vop_access_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_access, return, return, "struct vnode *", "struct vop_access_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_accessx, entry, entry, "struct vnode *", "struct vop_accessx_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_accessx, return, return, "struct vnode *", "struct vop_accessx_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_getattr, entry, entry, "struct vnode *", "struct vop_getattr_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_getattr, return, return, "struct vnode *", "struct vop_getattr_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_setattr, entry, entry, "struct vnode *", "struct vop_setattr_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_setattr, return, return, "struct vnode *", "struct vop_setattr_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_markatime, entry, entry, "struct vnode *", "struct vop_markatime_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_markatime, return, return, "struct vnode *", "struct vop_markatime_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_read, entry, entry, "struct vnode *", "struct vop_read_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_read, return, return, "struct vnode *", "struct vop_read_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_write, entry, entry, "struct vnode *", "struct vop_write_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_write, return, return, "struct vnode *", "struct vop_write_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_ioctl, entry, entry, "struct vnode *", "struct vop_ioctl_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_ioctl, return, return, "struct vnode *", "struct vop_ioctl_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_poll, entry, entry, "struct vnode *", "struct vop_poll_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_poll, return, return, "struct vnode *", "struct vop_poll_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_kqfilter, entry, entry, "struct vnode *", "struct vop_kqfilter_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_kqfilter, return, return, "struct vnode *", "struct vop_kqfilter_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_revoke, entry, entry, "struct vnode *", "struct vop_revoke_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_revoke, return, return, "struct vnode *", "struct vop_revoke_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_fsync, entry, entry, "struct vnode *", "struct vop_fsync_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_fsync, return, return, "struct vnode *", "struct vop_fsync_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_remove, entry, entry, "struct vnode *", "struct vop_remove_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_remove, return, return, "struct vnode *", "struct vop_remove_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_link, entry, entry, "struct vnode *", "struct vop_link_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_link, return, return, "struct vnode *", "struct vop_link_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_rename, entry, entry, "struct vnode *", "struct vop_rename_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_rename, return, return, "struct vnode *", "struct vop_rename_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_mkdir, entry, entry, "struct vnode *", "struct vop_mkdir_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_mkdir, return, return, "struct vnode *", "struct vop_mkdir_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_rmdir, entry, entry, "struct vnode *", "struct vop_rmdir_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_rmdir, return, return, "struct vnode *", "struct vop_rmdir_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_symlink, entry, entry, "struct vnode *", "struct vop_symlink_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_symlink, return, return, "struct vnode *", "struct vop_symlink_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_readdir, entry, entry, "struct vnode *", "struct vop_readdir_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_readdir, return, return, "struct vnode *", "struct vop_readdir_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_readlink, entry, entry, "struct vnode *", "struct vop_readlink_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_readlink, return, return, "struct vnode *", "struct vop_readlink_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_inactive, entry, entry, "struct vnode *", "struct vop_inactive_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_inactive, return, return, "struct vnode *", "struct vop_inactive_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_reclaim, entry, entry, "struct vnode *", "struct vop_reclaim_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_reclaim, return, return, "struct vnode *", "struct vop_reclaim_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_lock1, entry, entry, "struct vnode *", "struct vop_lock1_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_lock1, return, return, "struct vnode *", "struct vop_lock1_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_unlock, entry, entry, "struct vnode *", "struct vop_unlock_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_unlock, return, return, "struct vnode *", "struct vop_unlock_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_bmap, entry, entry, "struct vnode *", "struct vop_bmap_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_bmap, return, return, "struct vnode *", "struct vop_bmap_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_strategy, entry, entry, "struct vnode *", "struct vop_strategy_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_strategy, return, return, "struct vnode *", "struct vop_strategy_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_getwritemount, entry, entry, "struct vnode *", "struct vop_getwritemount_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_getwritemount, return, return, "struct vnode *", "struct vop_getwritemount_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_print, entry, entry, "struct vnode *", "struct vop_print_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_print, return, return, "struct vnode *", "struct vop_print_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_pathconf, entry, entry, "struct vnode *", "struct vop_pathconf_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_pathconf, return, return, "struct vnode *", "struct vop_pathconf_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_advlock, entry, entry, "struct vnode *", "struct vop_advlock_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_advlock, return, return, "struct vnode *", "struct vop_advlock_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_advlockasync, entry, entry, "struct vnode *", "struct vop_advlockasync_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_advlockasync, return, return, "struct vnode *", "struct vop_advlockasync_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_advlockpurge, entry, entry, "struct vnode *", "struct vop_advlockpurge_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_advlockpurge, return, return, "struct vnode *", "struct vop_advlockpurge_args *", "int");
...
VOP_ADVLOCKPURGE_APV(struct vop_vector *vop, struct vop_advlockpurge_args *a)
{
	...
	SDT_PROBE(vfs, vop, vop_advlockpurge, entry, a->a_vp, a, 0, 0, 0);
	...
	VFS_EPILOGUE(a->a_vp->v_mount);
	CTR1(KTR_VOP,
	    "VOP_ADVLOCKPURGE(vp 0x%lX)",
	    a->a_vp);
	SDT_PROBE(vfs, vop, vop_advlockpurge, return, a->a_vp, a, rc, 0, 0);
...
SDT_PROBE_DEFINE2(vfs, vop, vop_reallocblks, entry, entry, "struct vnode *", "struct vop_reallocblks_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_reallocblks, return, return, "struct vnode *", "struct vop_reallocblks_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_getpages, entry, entry, "struct vnode *", "struct vop_getpages_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_getpages, return, return, "struct vnode *", "struct vop_getpages_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_putpages, entry, entry, "struct vnode *", "struct vop_putpages_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_putpages, return, return, "struct vnode *", "struct vop_putpages_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_getacl, entry, entry, "struct vnode *", "struct vop_getacl_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_getacl, return, return, "struct vnode *", "struct vop_getacl_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_setacl, entry, entry, "struct vnode *", "struct vop_setacl_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_setacl, return, return, "struct vnode *", "struct vop_setacl_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_aclcheck, entry, entry, "struct vnode *", "struct vop_aclcheck_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_aclcheck, return, return, "struct vnode *", "struct vop_aclcheck_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_closeextattr, entry, entry, "struct vnode *", "struct vop_closeextattr_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_closeextattr, return, return, "struct vnode *", "struct vop_closeextattr_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_getextattr, entry, entry, "struct vnode *", "struct vop_getextattr_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_getextattr, return, return, "struct vnode *", "struct vop_getextattr_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_listextattr, entry, entry, "struct vnode *", "struct vop_listextattr_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_listextattr, return, return, "struct vnode *", "struct vop_listextattr_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_openextattr, entry, entry, "struct vnode *", "struct vop_openextattr_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_openextattr, return, return, "struct vnode *", "struct vop_openextattr_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_deleteextattr, entry, entry, "struct vnode *", "struct vop_deleteextattr_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_deleteextattr, return, return, "struct vnode *", "struct vop_deleteextattr_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_setextattr, entry, entry, "struct vnode *", "struct vop_setextattr_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_setextattr, return, return, "struct vnode *", "struct vop_setextattr_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_setlabel, entry, entry, "struct vnode *", "struct vop_setlabel_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_setlabel, return, return, "struct vnode *", "struct vop_setlabel_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_vptofh, entry, entry, "struct vnode *", "struct vop_vptofh_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_vptofh, return, return, "struct vnode *", "struct vop_vptofh_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_vptocnp, entry, entry, "struct vnode *", "struct vop_vptocnp_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_vptocnp, return, return, "struct vnode *", "struct vop_vptocnp_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_allocate, entry, entry, "struct vnode *", "struct vop_allocate_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_allocate, return, return, "struct vnode *", "struct vop_allocate_args *", "int");
...
VOP_ALLOCATE_APV(struct vop_vector *vop, struct vop_allocate_args *a)
{
	...
	SDT_PROBE(vfs, vop, vop_allocate, entry, a->a_vp, a, 0, 0, 0);
	...
	VFS_EPILOGUE(a->a_vp->v_mount);
	CTR3(KTR_VOP,
	    "VOP_ALLOCATE(vp 0x%lX, offset 0x%lX, len 0x%lX)",
	    a->a_vp, a->a_offset, a->a_len);
	SDT_PROBE(vfs, vop, vop_allocate, return, a->a_vp, a, rc, 0, 0);
...
SDT_PROBE_DEFINE2(vfs, vop, vop_advise, entry, entry, "struct vnode *", "struct vop_advise_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_advise, return, return, "struct vnode *", "struct vop_advise_args *", "int");
...
VOP_ADVISE_APV(struct vop_vector *vop, struct vop_advise_args *a)
{
	...
	SDT_PROBE(vfs, vop, vop_advise, entry, a->a_vp, a, 0, 0, 0);
	...
	VFS_EPILOGUE(a->a_vp->v_mount);
	CTR4(KTR_VOP,
	    "VOP_ADVISE(vp 0x%lX, start %ld, end %ld, advice %ld)",
	    a->a_vp, a->a_start, a->a_end, a->a_advice);
	SDT_PROBE(vfs, vop, vop_advise, return, a->a_vp, a, rc, 0, 0);
...
SDT_PROBE_DEFINE2(vfs, vop, vop_unp_bind, entry, entry, "struct vnode *", "struct vop_unp_bind_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_unp_bind, return, return, "struct vnode *", "struct vop_unp_bind_args *", "int");
...
VOP_UNP_BIND_APV(struct vop_vector *vop, struct vop_unp_bind_args *a)
{
	...
	SDT_PROBE(vfs, vop, vop_unp_bind, entry, a->a_vp, a, 0, 0, 0);
	...
	VFS_EPILOGUE(a->a_vp->v_mount);
	CTR2(KTR_VOP,
	    "VOP_UNP_BIND(vp 0x%lX, socket 0x%lX)",
	    a->a_vp, a->a_socket);
	SDT_PROBE(vfs, vop, vop_unp_bind, return, a->a_vp, a, rc, 0, 0);
...
SDT_PROBE_DEFINE2(vfs, vop, vop_unp_connect, entry, entry, "struct vnode *", "struct vop_unp_connect_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_unp_connect, return, return, "struct vnode *", "struct vop_unp_connect_args *", "int");
...
VOP_UNP_CONNECT_APV(struct vop_vector *vop, struct vop_unp_connect_args *a)
{
	...
	SDT_PROBE(vfs, vop, vop_unp_connect, entry, a->a_vp, a, 0, 0, 0);
	...
	VFS_EPILOGUE(a->a_vp->v_mount);
	CTR2(KTR_VOP,
	    "VOP_UNP_CONNECT(vp 0x%lX, socket 0x%lX)",
	    a->a_vp, a->a_socket);
	SDT_PROBE(vfs, vop, vop_unp_connect, return, a->a_vp, a, rc, 0, 0);
...
SDT_PROBE_DEFINE2(vfs, vop, vop_unp_detach, entry, entry, "struct vnode *", "struct vop_unp_detach_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_unp_detach, return, return, "struct vnode *", "struct vop_unp_detach_args *", "int");
...
VOP_UNP_DETACH_APV(struct vop_vector *vop, struct vop_unp_detach_args *a)
{
	...
	SDT_PROBE(vfs, vop, vop_unp_detach, entry, a->a_vp, a, 0, 0, 0);
	...
	VFS_EPILOGUE(a->a_vp->v_mount);
	CTR1(KTR_VOP,
	    "VOP_UNP_DETACH(vp 0x%lX)",
	    a->a_vp);
	SDT_PROBE(vfs, vop, vop_unp_detach, return, a->a_vp, a, rc, 0, 0);
...
SDT_PROBE_DEFINE2(vfs, vop, vop_is_text, entry, entry, "struct vnode *", "struct vop_is_text_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_is_text, return, return, "struct vnode *", "struct vop_is_text_args *", "int");
...
VOP_IS_TEXT_APV(struct vop_vector *vop, struct vop_is_text_args *a)
{
	...
	SDT_PROBE(vfs, vop, vop_is_text, entry, a->a_vp, a, 0, 0, 0);
	...
	VFS_EPILOGUE(a->a_vp->v_mount);
	CTR1(KTR_VOP,
	    "VOP_IS_TEXT(vp 0x%lX)",
	    a->a_vp);
	SDT_PROBE(vfs, vop, vop_is_text, return, a->a_vp, a, rc, 0, 0);
...
SDT_PROBE_DEFINE2(vfs, vop, vop_set_text, entry, entry, "struct vnode *", "struct vop_set_text_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_set_text, return, return, "struct vnode *", "struct vop_set_text_args *", "int");
...
VOP_SET_TEXT_APV(struct vop_vector *vop, struct vop_set_text_args *a)
{
	...
	SDT_PROBE(vfs, vop, vop_set_text, entry, a->a_vp, a, 0, 0, 0);
	...
	VFS_EPILOGUE(a->a_vp->v_mount);
	CTR1(KTR_VOP,
	    "VOP_SET_TEXT(vp 0x%lX)",
	    a->a_vp);
	SDT_PROBE(vfs, vop, vop_set_text, return, a->a_vp, a, rc, 0, 0);
...
SDT_PROBE_DEFINE2(vfs, vop, vop_unset_text, entry, entry, "struct vnode *", "struct vop_unset_text_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_unset_text, return, return, "struct vnode *", "struct vop_unset_text_args *", "int");
...
VOP_UNSET_TEXT_APV(struct vop_vector *vop, struct vop_unset_text_args *a)
{
	...
	SDT_PROBE(vfs, vop, vop_unset_text, entry, a->a_vp, a, 0, 0, 0);
	...
	VFS_EPILOGUE(a->a_vp->v_mount);
	CTR1(KTR_VOP,
	    "VOP_UNSET_TEXT(vp 0x%lX)",
	    a->a_vp);
	SDT_PROBE(vfs, vop, vop_unset_text, return, a->a_vp, a, rc, 0, 0);
...
SDT_PROBE_DEFINE2(vfs, vop, vop_get_writecount, entry, entry, "struct vnode *", "struct vop_get_writecount_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_get_writecount, return, return, "struct vnode *", "struct vop_get_writecount_args *", "int");
...
VOP_GET_WRITECOUNT_APV(struct vop_vector *vop, struct vop_get_writecount_args *a)
{
	...
	SDT_PROBE(vfs, vop, vop_get_writecount, entry, a->a_vp, a, 0, 0, 0);
	...
	VFS_EPILOGUE(a->a_vp->v_mount);
	CTR2(KTR_VOP,
	    "VOP_GET_WRITECOUNT(vp 0x%lX, writecount 0x%lX)",
	    a->a_vp, a->a_writecount);
	SDT_PROBE(vfs, vop, vop_get_writecount, return, a->a_vp, a, rc, 0, 0);
...
SDT_PROBE_DEFINE2(vfs, vop, vop_add_writecount, entry, entry, "struct vnode *", "struct vop_add_writecount_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_add_writecount, return, return, "struct vnode *", "struct vop_add_writecount_args *", "int");
...
SDT_PROBE_DEFINE2(vfs, vop, vop_spare4, entry, entry, "struct vnode *", "struct vop_spare4_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_spare4, return, return, "struct vnode *", "struct vop_spare4_args *", "int");
...
VOP_SPARE4_APV(struct vop_vector *vop, struct vop_spare4_args *a)
{
	...
	SDT_PROBE(vfs, vop, vop_spare4, entry, a->a_vp, a, 0, 0, 0);
	...
	CTR1(KTR_VOP,
	    "VOP_SPARE4(vp 0x%lX)",
	    a->a_vp);
	SDT_PROBE(vfs, vop, vop_spare4, return, a->a_vp, a, rc, 0, 0);
...
SDT_PROBE_DEFINE2(vfs, vop, vop_spare5, entry, entry, "struct vnode *", "struct vop_spare5_args *");

SDT_PROBE_DEFINE3(vfs, vop, vop_spare5, return, return, "struct vnode *", "struct vop_spare5_args *", "int");
...
VOP_SPARE5_APV(struct vop_vector *vop, struct vop_spare5_args *a)
{
	...
	SDT_PROBE(vfs, vop, vop_spare5, entry, a->a_vp, a, 0, 0, 0);
	...
	CTR1(KTR_VOP,
	    "VOP_SPARE5(vp 0x%lX)",
	    a->a_vp);
	SDT_PROBE(vfs, vop, vop_spare5, return, a->a_vp, a, rc, 0, 0);
