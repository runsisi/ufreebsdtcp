...
#define	PAD_(t)	(sizeof(bsd_register_t) <= sizeof(t) ? \
		0 : sizeof(bsd_register_t) - sizeof(t))
...
struct read_args {
	...
	char nbyte_l_[PADL_(bsd_size_t)]; bsd_size_t nbyte; char nbyte_r_[PADR_(bsd_size_t)];
};
struct write_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
...
struct setuid_args {
	char uid_l_[PADL_(bsd_uid_t)]; bsd_uid_t uid; char uid_r_[PADR_(bsd_uid_t)];
};
struct getuid_args {
	bsd_register_t dummy;
};
...
struct ptrace_args {
	...
	char pid_l_[PADL_(bsd_pid_t)]; bsd_pid_t pid; char pid_r_[PADR_(bsd_pid_t)];
	char addr_l_[PADL_(caddr_t)]; caddr_t addr; char addr_r_[PADR_(caddr_t)];
	char data_l_[PADL_(int)]; int data; char data_r_[PADR_(int)];
};
struct recvmsg_args {
	char s_l_[PADL_(int)]; int s; char s_r_[PADR_(int)];
	char msg_l_[PADL_(struct bsd_msghdr *)]; struct bsd_msghdr * msg; char msg_r_[PADR_(struct bsd_msghdr *)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
};
struct sendmsg_args {
	char s_l_[PADL_(int)]; int s; char s_r_[PADR_(int)];
...
struct recvfrom_args {
	...
	char len_l_[PADL_(bsd_size_t)]; bsd_size_t len; char len_r_[PADR_(bsd_size_t)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
	char from_l_[PADL_(struct bsd_sockaddr *__restrict)]; struct bsd_sockaddr *__restrict from; char from_r_[PADR_(struct bsd_sockaddr *__restrict)];
	char fromlenaddr_l_[PADL_(__bsd_socklen_t *__restrict)]; __bsd_socklen_t *__restrict fromlenaddr; char fromlenaddr_r_[PADR_(__bsd_socklen_t *__restrict)];
};
struct accept_args {
	char s_l_[PADL_(int)]; int s; char s_r_[PADR_(int)];
	char name_l_[PADL_(struct bsd_sockaddr *__restrict)]; struct bsd_sockaddr *__restrict name; char name_r_[PADR_(struct bsd_sockaddr *__restrict)];
	char anamelen_l_[PADL_(__bsd_socklen_t *__restrict)]; __bsd_socklen_t *__restrict anamelen; char anamelen_r_[PADR_(__bsd_socklen_t *__restrict)];
};
struct getpeername_args {
	char fdes_l_[PADL_(int)]; int fdes; char fdes_r_[PADR_(int)];
	char asa_l_[PADL_(struct bsd_sockaddr *__restrict)]; struct bsd_sockaddr *__restrict asa; char asa_r_[PADR_(struct bsd_sockaddr *__restrict)];
	char alen_l_[PADL_(__bsd_socklen_t *__restrict)]; __bsd_socklen_t *__restrict alen; char alen_r_[PADR_(__bsd_socklen_t *__restrict)];
};
...
struct profil_args {
	...
	char size_l_[PADL_(bsd_size_t)]; bsd_size_t size; char size_r_[PADR_(bsd_size_t)];
	char offset_l_[PADL_(bsd_size_t)]; bsd_size_t offset; char offset_r_[PADR_(bsd_size_t)];
...
struct sigaltstack_args {
	char ss_l_[PADL_(bsd_stack_t *)]; bsd_stack_t * ss; char ss_r_[PADR_(bsd_stack_t *)];
	char oss_l_[PADL_(bsd_stack_t *)]; bsd_stack_t * oss; char oss_r_[PADR_(bsd_stack_t *)];
};
struct ioctl_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
...
struct readlink_args {
	...
	char count_l_[PADL_(bsd_size_t)]; bsd_size_t count; char count_r_[PADR_(bsd_size_t)];
};
struct execve_args {
...
struct getgroups_args {
	...
	char gidset_l_[PADL_(bsd_gid_t *)]; bsd_gid_t * gidset; char gidset_r_[PADR_(bsd_gid_t *)];
};
...
struct setitimer_args {
	...
	char itv_l_[PADL_(struct bsd_itimerval *)]; struct bsd_itimerval * itv; char itv_r_[PADR_(struct bsd_itimerval *)];
	char oitv_l_[PADL_(struct bsd_itimerval *)]; struct bsd_itimerval * oitv; char oitv_r_[PADR_(struct bsd_itimerval *)];
};
struct owait_args {
	bsd_register_t dummy;
};
...
struct select_args {
	...
	char in_l_[PADL_(bsd_fd_set *)]; bsd_fd_set * in; char in_r_[PADR_(bsd_fd_set *)];
	char ou_l_[PADL_(bsd_fd_set *)]; bsd_fd_set * ou; char ou_r_[PADR_(bsd_fd_set *)];
	char ex_l_[PADL_(bsd_fd_set *)]; bsd_fd_set * ex; char ex_r_[PADR_(bsd_fd_set *)];
	char tv_l_[PADL_(struct bsd_timeval *)]; struct bsd_timeval * tv; char tv_r_[PADR_(struct bsd_timeval *)];
};
struct fsync_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
};
...
struct gettimeofday_args {
	char tp_l_[PADL_(struct bsd_timeval *)]; struct bsd_timeval * tp; char tp_r_[PADR_(struct bsd_timeval *)];
	char tzp_l_[PADL_(struct bsd_timezone *)]; struct bsd_timezone * tzp; char tzp_r_[PADR_(struct bsd_timezone *)];
};
...
struct readv_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char iovp_l_[PADL_(struct bsd_iovec *)]; struct bsd_iovec * iovp; char iovp_r_[PADR_(struct bsd_iovec *)];
...
struct utimes_args {
	char path_l_[PADL_(char *)]; char * path; char path_r_[PADR_(char *)];
	char tptr_l_[PADL_(struct bsd_timeval *)]; struct bsd_timeval * tptr; char tptr_r_[PADR_(struct bsd_timeval *)];
};
struct adjtime_args {
	char delta_l_[PADL_(struct bsd_timeval *)]; struct bsd_timeval * delta; char delta_r_[PADR_(struct bsd_timeval *)];
	char olddelta_l_[PADL_(struct bsd_timeval *)]; struct bsd_timeval * olddelta; char olddelta_r_[PADR_(struct bsd_timeval *)];
};
...
struct freebsd6_pread_args {
	...
	char offset_l_[PADL_(bsd_off_t)]; bsd_off_t offset; char offset_r_[PADR_(bsd_off_t)];
};
...
struct setgid_args {
	char gid_l_[PADL_(bsd_gid_t)]; bsd_gid_t gid; char gid_r_[PADR_(bsd_gid_t)];
};
struct setegid_args {
	char egid_l_[PADL_(bsd_gid_t)]; bsd_gid_t egid; char egid_r_[PADR_(bsd_gid_t)];
};
struct seteuid_args {
	char euid_l_[PADL_(bsd_uid_t)]; bsd_uid_t euid; char euid_r_[PADR_(bsd_uid_t)];
};
struct stat_args {
	char path_l_[PADL_(char *)]; char * path; char path_r_[PADR_(char *)];
	char ub_l_[PADL_(struct bsd_stat *)]; struct bsd_stat * ub; char ub_r_[PADR_(struct bsd_stat *)];
};
struct fstat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char sb_l_[PADL_(struct bsd_stat *)]; struct bsd_stat * sb; char sb_r_[PADR_(struct bsd_stat *)];
};
struct lstat_args {
	char path_l_[PADL_(char *)]; char * path; char path_r_[PADR_(char *)];
	char ub_l_[PADL_(struct bsd_stat *)]; struct bsd_stat * ub; char ub_r_[PADR_(struct bsd_stat *)];
...
struct freebsd6_mmap_args {
	...
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char pad_l_[PADL_(int)]; int pad; char pad_r_[PADR_(int)];
	char pos_l_[PADL_(bsd_off_t)]; bsd_off_t pos; char pos_r_[PADR_(bsd_off_t)];
};
...
struct freebsd6_truncate_args {
	char path_l_[PADL_(char *)]; char * path; char path_r_[PADR_(char *)];
	char pad_l_[PADL_(int)]; int pad; char pad_r_[PADR_(int)];
	char length_l_[PADL_(bsd_off_t)]; bsd_off_t length; char length_r_[PADR_(bsd_off_t)];
};
...
struct sysctl_args {
	...
	char oldlenp_l_[PADL_(bsd_size_t *)]; bsd_size_t * oldlenp; char oldlenp_r_[PADR_(bsd_size_t *)];
	char new_l_[PADL_(void *)]; void * new; char new_r_[PADR_(void *)];
	char newlen_l_[PADL_(bsd_size_t)]; bsd_size_t newlen; char newlen_r_[PADR_(bsd_size_t)];
};
struct mlock_args {
	char addr_l_[PADL_(const void *)]; const void * addr; char addr_r_[PADR_(const void *)];
	char len_l_[PADL_(bsd_size_t)]; bsd_size_t len; char len_r_[PADR_(bsd_size_t)];
...
struct poll_args {
	char fds_l_[PADL_(struct bsd_pollfd *)]; struct bsd_pollfd * fds; char fds_r_[PADR_(struct bsd_pollfd *)];
	char nfds_l_[PADL_(u_int)]; u_int nfds; char nfds_r_[PADR_(u_int)];
	char timeout_l_[PADL_(int)]; int timeout; char timeout_r_[PADR_(int)];
};
struct semget_args {
	char key_l_[PADL_(bsd_key_t)]; bsd_key_t key; char key_r_[PADR_(bsd_key_t)];
...
struct semop_args {
	...
	char nsops_l_[PADL_(bsd_size_t)]; bsd_size_t nsops; char nsops_r_[PADR_(bsd_size_t)];
};
struct msgget_args {
	char key_l_[PADL_(bsd_key_t)]; bsd_key_t key; char key_r_[PADR_(bsd_key_t)];
...
struct msgsnd_args {
	...
	char msgsz_l_[PADL_(bsd_size_t)]; bsd_size_t msgsz; char msgsz_r_[PADR_(bsd_size_t)];
	char msgflg_l_[PADL_(int)]; int msgflg; char msgflg_r_[PADR_(int)];
};
struct msgrcv_args {
	char msqid_l_[PADL_(int)]; int msqid; char msqid_r_[PADR_(int)];
...
struct clock_gettime_args {
	char clock_id_l_[PADL_(bsd_clockid_t)]; bsd_clockid_t clock_id; char clock_id_r_[PADR_(bsd_clockid_t)];
	char tp_l_[PADL_(struct bsd_timespec *)]; struct bsd_timespec * tp; char tp_r_[PADR_(struct bsd_timespec *)];
};
struct clock_settime_args {
	char clock_id_l_[PADL_(bsd_clockid_t)]; bsd_clockid_t clock_id; char clock_id_r_[PADR_(bsd_clockid_t)];
	char tp_l_[PADL_(const struct bsd_timespec *)]; const struct bsd_timespec * tp; char tp_r_[PADR_(const struct bsd_timespec *)];
};
...
struct ktimer_settime_args {
	char timerid_l_[PADL_(int)]; int timerid; char timerid_r_[PADR_(int)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
	char value_l_[PADL_(const struct bsd_itimerspec *)]; const struct bsd_itimerspec * value; char value_r_[PADR_(const struct bsd_itimerspec *)];
	char ovalue_l_[PADL_(struct bsd_itimerspec *)]; struct bsd_itimerspec * ovalue; char ovalue_r_[PADR_(struct bsd_itimerspec *)];
};
struct ktimer_gettime_args {
	char timerid_l_[PADL_(int)]; int timerid; char timerid_r_[PADR_(int)];
	char value_l_[PADL_(struct bsd_itimerspec *)]; struct bsd_itimerspec * value; char value_r_[PADR_(struct bsd_itimerspec *)];
};
struct ktimer_getoverrun_args {
	char timerid_l_[PADL_(int)]; int timerid; char timerid_r_[PADR_(int)];
};
struct nanosleep_args {
	char rqtp_l_[PADL_(const struct bsd_timespec *)]; const struct bsd_timespec * rqtp; char rqtp_r_[PADR_(const struct bsd_timespec *)];
	char rmtp_l_[PADL_(struct bsd_timespec *)]; struct bsd_timespec * rmtp; char rmtp_r_[PADR_(struct bsd_timespec *)];
};
...
struct lchmod_args {
	char path_l_[PADL_(char *)]; char * path; char path_r_[PADR_(char *)];
	char mode_l_[PADL_(bsd_mode_t)]; bsd_mode_t mode; char mode_r_[PADR_(bsd_mode_t)];
};
struct lutimes_args {
	char path_l_[PADL_(char *)]; char * path; char path_r_[PADR_(char *)];
	char tptr_l_[PADL_(struct bsd_timeval *)]; struct bsd_timeval * tptr; char tptr_r_[PADR_(struct bsd_timeval *)];
...
struct setresuid_args {
	char ruid_l_[PADL_(bsd_uid_t)]; bsd_uid_t ruid; char ruid_r_[PADR_(bsd_uid_t)];
	char euid_l_[PADL_(bsd_uid_t)]; bsd_uid_t euid; char euid_r_[PADR_(bsd_uid_t)];
	char suid_l_[PADL_(bsd_uid_t)]; bsd_uid_t suid; char suid_r_[PADR_(bsd_uid_t)];
};
struct setresgid_args {
	char rgid_l_[PADL_(bsd_gid_t)]; bsd_gid_t rgid; char rgid_r_[PADR_(bsd_gid_t)];
	char egid_l_[PADL_(bsd_gid_t)]; bsd_gid_t egid; char egid_r_[PADR_(bsd_gid_t)];
	char sgid_l_[PADL_(bsd_gid_t)]; bsd_gid_t sgid; char sgid_r_[PADR_(bsd_gid_t)];
};
...
struct aio_suspend_args {
	...
	char nent_l_[PADL_(int)]; int nent; char nent_r_[PADR_(int)];
	char timeout_l_[PADL_(const struct bsd_timespec *)]; const struct bsd_timespec * timeout; char timeout_r_[PADR_(const struct bsd_timespec *)];
};
...
struct sched_rr_get_interval_args {
	char pid_l_[PADL_(bsd_pid_t)]; bsd_pid_t pid; char pid_r_[PADR_(bsd_pid_t)];
	char interval_l_[PADL_(struct bsd_timespec *)]; struct bsd_timespec * interval; char interval_r_[PADR_(struct bsd_timespec *)];
};
struct utrace_args {
	char addr_l_[PADL_(const void *)]; const void * addr; char addr_r_[PADR_(const void *)];
	char len_l_[PADL_(bsd_size_t)]; bsd_size_t len; char len_r_[PADR_(bsd_size_t)];
...
struct sigtimedwait_args {
	char set_l_[PADL_(const bsd_sigset_t *)]; const bsd_sigset_t * set; char set_r_[PADR_(const bsd_sigset_t *)];
	char info_l_[PADL_(bsd_siginfo_t *)]; bsd_siginfo_t * info; char info_r_[PADR_(bsd_siginfo_t *)];
	char timeout_l_[PADL_(const struct bsd_timespec *)]; const struct bsd_timespec * timeout; char timeout_r_[PADR_(const struct bsd_timespec *)];
};
...
struct extattr_set_file_args {
	...
	char attrname_l_[PADL_(const char *)]; const char * attrname; char attrname_r_[PADR_(const char *)];
	char data_l_[PADL_(void *)]; void * data; char data_r_[PADR_(void *)];
	char nbytes_l_[PADL_(bsd_size_t)]; bsd_size_t nbytes; char nbytes_r_[PADR_(bsd_size_t)];
};
...
struct aio_waitcomplete_args {
	char aiocbp_l_[PADL_(struct aiocb **)]; struct aiocb ** aiocbp; char aiocbp_r_[PADR_(struct aiocb **)];
	char timeout_l_[PADL_(struct bsd_timespec *)]; struct bsd_timespec * timeout; char timeout_r_[PADR_(struct bsd_timespec *)];
};
...
struct sendfile_args {
	...
	char offset_l_[PADL_(bsd_off_t)]; bsd_off_t offset; char offset_r_[PADR_(bsd_off_t)];
	char nbytes_l_[PADL_(bsd_size_t)]; bsd_size_t nbytes; char nbytes_r_[PADR_(bsd_size_t)];
	char hdtr_l_[PADL_(struct bsd_sf_hdtr *)]; struct bsd_sf_hdtr * hdtr; char hdtr_r_[PADR_(struct bsd_sf_hdtr *)];
	char sbytes_l_[PADL_(bsd_off_t *)]; bsd_off_t * sbytes; char sbytes_r_[PADR_(bsd_off_t *)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
};
...
struct ksem_timedwait_args {
	char id_l_[PADL_(semid_t)]; semid_t id; char id_r_[PADR_(semid_t)];
	char abstime_l_[PADL_(const struct bsd_timespec *)]; const struct bsd_timespec * abstime; char abstime_r_[PADR_(const struct bsd_timespec *)];
};
...
struct getauid_args {
	char auid_l_[PADL_(bsd_uid_t *)]; bsd_uid_t * auid; char auid_r_[PADR_(bsd_uid_t *)];
};
struct setauid_args {
	char auid_l_[PADL_(bsd_uid_t *)]; bsd_uid_t * auid; char auid_r_[PADR_(bsd_uid_t *)];
};
...
struct kmq_timedreceive_args {
	...
	char msg_len_l_[PADL_(bsd_size_t)]; bsd_size_t msg_len; char msg_len_r_[PADR_(bsd_size_t)];
	char msg_prio_l_[PADL_(unsigned *)]; unsigned * msg_prio; char msg_prio_r_[PADR_(unsigned *)];
	char abs_timeout_l_[PADL_(const struct bsd_timespec *)]; const struct bsd_timespec * abs_timeout; char abs_timeout_r_[PADR_(const struct bsd_timespec *)];
};
...
struct rtprio_thread_args {
	char function_l_[PADL_(int)]; int function; char function_r_[PADR_(int)];
	char lwpid_l_[PADL_(bsd_lwpid_t)]; bsd_lwpid_t lwpid; char lwpid_r_[PADR_(bsd_lwpid_t)];
	char rtp_l_[PADL_(struct rtprio *)]; struct rtprio * rtp; char rtp_r_[PADR_(struct rtprio *)];
};
struct sctp_peeloff_args {
	char sd_l_[PADL_(int)]; int sd; char sd_r_[PADR_(int)];
	char name_l_[PADL_(bsd_uint32_t)]; bsd_uint32_t name; char name_r_[PADR_(bsd_uint32_t)];
};
struct sctp_generic_sendmsg_args {
	...
	char to_l_[PADL_(caddr_t)]; caddr_t to; char to_r_[PADR_(caddr_t)];
	char tolen_l_[PADL_(__bsd_socklen_t)]; __bsd_socklen_t tolen; char tolen_r_[PADR_(__bsd_socklen_t)];
...
struct sctp_generic_sendmsg_iov_args {
	char sd_l_[PADL_(int)]; int sd; char sd_r_[PADR_(int)];
	char iov_l_[PADL_(struct bsd_iovec *)]; struct bsd_iovec * iov; char iov_r_[PADR_(struct bsd_iovec *)];
...
struct sctp_generic_recvmsg_args {
	...
	char iov_l_[PADL_(struct bsd_iovec *)]; struct bsd_iovec * iov; char iov_r_[PADR_(struct bsd_iovec *)];
	char iovlen_l_[PADL_(int)]; int iovlen; char iovlen_r_[PADR_(int)];
	char from_l_[PADL_(struct bsd_sockaddr *)]; struct bsd_sockaddr * from; char from_r_[PADR_(struct bsd_sockaddr *)];
	char fromlenaddr_l_[PADL_(__bsd_socklen_t *)]; __bsd_socklen_t * fromlenaddr; char fromlenaddr_r_[PADR_(__bsd_socklen_t *)];
	char sinfo_l_[PADL_(struct sctp_sndrcvinfo *)]; struct sctp_sndrcvinfo * sinfo; char sinfo_r_[PADR_(struct sctp_sndrcvinfo *)];
...
struct cpuset_args {
	char setid_l_[PADL_(bsd_cpusetid_t *)]; bsd_cpusetid_t * setid; char setid_r_[PADR_(bsd_cpusetid_t *)];
};
struct cpuset_setid_args {
	char which_l_[PADL_(bsd_cpuwhich_t)]; bsd_cpuwhich_t which; char which_r_[PADR_(bsd_cpuwhich_t)];
	char id_l_[PADL_(bsd_id_t)]; bsd_id_t id; char id_r_[PADR_(bsd_id_t)];
	char setid_l_[PADL_(bsd_cpusetid_t)]; bsd_cpusetid_t setid; char setid_r_[PADR_(bsd_cpusetid_t)];
};
struct cpuset_getid_args {
	char level_l_[PADL_(bsd_cpulevel_t)]; bsd_cpulevel_t level; char level_r_[PADR_(bsd_cpulevel_t)];
	char which_l_[PADL_(bsd_cpuwhich_t)]; bsd_cpuwhich_t which; char which_r_[PADR_(bsd_cpuwhich_t)];
	char id_l_[PADL_(bsd_id_t)]; bsd_id_t id; char id_r_[PADR_(bsd_id_t)];
	char setid_l_[PADL_(bsd_cpusetid_t *)]; bsd_cpusetid_t * setid; char setid_r_[PADR_(bsd_cpusetid_t *)];
};
struct cpuset_getaffinity_args {
	...
	char which_l_[PADL_(bsd_cpuwhich_t)]; bsd_cpuwhich_t which; char which_r_[PADR_(bsd_cpuwhich_t)];
	char id_l_[PADL_(bsd_id_t)]; bsd_id_t id; char id_r_[PADR_(bsd_id_t)];
	char cpusetsize_l_[PADL_(bsd_size_t)]; bsd_size_t cpusetsize; char cpusetsize_r_[PADR_(bsd_size_t)];
...
struct fstatat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char path_l_[PADL_(char *)]; char * path; char path_r_[PADR_(char *)];
	char buf_l_[PADL_(struct bsd_stat *)]; struct bsd_stat * buf; char buf_r_[PADR_(struct bsd_stat *)];
	char flag_l_[PADL_(int)]; int flag; char flag_r_[PADR_(int)];
};
struct futimesat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char path_l_[PADL_(char *)]; char * path; char path_r_[PADR_(char *)];
	char times_l_[PADL_(struct bsd_timeval *)]; struct bsd_timeval * times; char times_r_[PADR_(struct bsd_timeval *)];
};
struct linkat_args {
...
struct mknodat_args {
	...
	char path_l_[PADL_(char *)]; char * path; char path_r_[PADR_(char *)];
	char mode_l_[PADL_(bsd_mode_t)]; bsd_mode_t mode; char mode_r_[PADR_(bsd_mode_t)];
	char dev_l_[PADL_(bsd_dev_t)]; bsd_dev_t dev; char dev_r_[PADR_(bsd_dev_t)];
};
struct openat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char path_l_[PADL_(char *)]; char * path; char path_r_[PADR_(char *)];
...
struct readlinkat_args {
	...
	char path_l_[PADL_(char *)]; char * path; char path_r_[PADR_(char *)];
	char buf_l_[PADL_(char *)]; char * buf; char buf_r_[PADR_(char *)];
	char bufsize_l_[PADL_(bsd_size_t)]; bsd_size_t bufsize; char bufsize_r_[PADR_(bsd_size_t)];
};
...
struct cap_new_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char rights_l_[PADL_(bsd_uint64_t)]; bsd_uint64_t rights; char rights_r_[PADR_(bsd_uint64_t)];
};
struct cap_getrights_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char rightsp_l_[PADL_(bsd_uint64_t *)]; bsd_uint64_t * rightsp; char rightsp_r_[PADR_(bsd_uint64_t *)];
};
...
struct pdgetpid_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char pidp_l_[PADL_(bsd_pid_t *)]; bsd_pid_t * pidp; char pidp_r_[PADR_(bsd_pid_t *)];
};
struct pselect_args {
	char nd_l_[PADL_(int)]; int nd; char nd_r_[PADR_(int)];
	char in_l_[PADL_(bsd_fd_set *)]; bsd_fd_set * in; char in_r_[PADR_(bsd_fd_set *)];
	char ou_l_[PADL_(bsd_fd_set *)]; bsd_fd_set * ou; char ou_r_[PADR_(bsd_fd_set *)];
	char ex_l_[PADL_(bsd_fd_set *)]; bsd_fd_set * ex; char ex_r_[PADR_(bsd_fd_set *)];
	char ts_l_[PADL_(const struct bsd_timespec *)]; const struct bsd_timespec * ts; char ts_r_[PADR_(const struct bsd_timespec *)];
	char sm_l_[PADL_(const bsd_sigset_t *)]; const bsd_sigset_t * sm; char sm_r_[PADR_(const bsd_sigset_t *)];
};
struct getloginclass_args {
	char namebuf_l_[PADL_(char *)]; char * namebuf; char namebuf_r_[PADR_(char *)];
	char namelen_l_[PADL_(bsd_size_t)]; bsd_size_t namelen; char namelen_r_[PADR_(bsd_size_t)];
};
...
struct rctl_get_racct_args {
	...
	char inbuflen_l_[PADL_(bsd_size_t)]; bsd_size_t inbuflen; char inbuflen_r_[PADR_(bsd_size_t)];
	char outbufp_l_[PADL_(void *)]; void * outbufp; char outbufp_r_[PADR_(void *)];
	char outbuflen_l_[PADL_(bsd_size_t)]; bsd_size_t outbuflen; char outbuflen_r_[PADR_(bsd_size_t)];
};
...
struct posix_fallocate_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char offset_l_[PADL_(bsd_off_t)]; bsd_off_t offset; char offset_r_[PADR_(bsd_off_t)];
	char len_l_[PADL_(bsd_off_t)]; bsd_off_t len; char len_r_[PADR_(bsd_off_t)];
};
